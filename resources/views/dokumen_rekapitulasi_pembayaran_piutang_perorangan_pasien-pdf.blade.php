...
<html lang="en">
    ...
    <body>
        ...
        <div style="text-align: center;">
            <img src="{{ public_path('header-pelaporan.png') }}" alt="Logo" class="img-fluid" style="width:95%; height:auto;">
        </div>
        ...
        <table style="border-spacing: 0; margin: auto;">
            <thead>
                <tr>
                    <td class="table-header" style="width: 250px;">Tanggal</td>
                    <td class="table-header" style="width: 160px;">R. Inap</td>
                    <td class="table-header" style="width: 160px;">R. Jalan</td>
                    <td class="table-header" style="width: 160px;">Total</td>
                </tr>
            </thead>
            @php
            ...
            @foreach ($collectData as $row)
                <tr>
                    <td class="table-data">{{ \Carbon\Carbon::parse($row->tgl_dokumen)->format('d-M-Y') }}</td>
        ...
        <div style="font-size: 15px; width: 100%; margin-top: 30px; margin-left: 50px;">
            <p style="float: left; width: 50%; text-align: left;">
                Mengetahui,<br>
                Kepala Bagian Keuangan
            </p>
            <p style="float: right; width: 50%; text-align: right; margin-right: 90px;">
        ...
        @endphp
        <div style="font-size: 15px; margin-top: 80px; margin-left: 50px;">
