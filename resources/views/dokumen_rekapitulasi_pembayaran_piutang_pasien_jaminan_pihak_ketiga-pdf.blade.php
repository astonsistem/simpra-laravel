...
<html lang="en">
    ...
    <body>
        ...
        <table style="border-spacing: 0; margin: auto;">
            <thead>
                <tr>
                    <td class="table-header" style="width: 30px; padding-top: 20px; padding-bottom: 20px;">No</td>
                    <td class="table-header" style="width: 120px; padding-top: 20px; padding-bottom: 20px;">Tanggal Bayar</td>
                    <td class="table-header" style="width: 250px; padding-top: 20px; padding-bottom: 20px;">Debitur</td>
                    <td class="table-header" style="width: 250px; padding-top: 20px; padding-bottom: 20px;">Bulan Pelayanan</td>
                    <td class="table-header" style="width: 150px; padding-top: 20px; padding-bottom: 20px;">Nominal</td>
                </tr>
            </thead>
            @php
            ...
            @foreach ($collectData as $row)
                <tr>
                    ...
                    <td class="table-data">{{ \Carbon\Carbon::parse($row->tgl_bayar)->format('d/m/Y') }}</td>
            ...
            @endforeach
            <tr>
                <td class="table-header" colspan="4">Total</td>
        ...
        <div style="font-size: 15px; width: 100%; margin-top: 10px; margin-left: 5px">
            ...
            <p style="float: right; width: 50%; text-align: right; margin-top: 145px; margin-right: 20px;">
